...
async function main() {
  ...
  const { startFleetGraphProactiveScheduler } = await import('./services/fleetgraph/proactive.js');
  ...
  const stopFleetGraphScheduler = startFleetGraphProactiveScheduler();
