...
Reviewer note closure: each test case now includes the exact per-run public LangSmith URL (copied from each trace's "View in LangSmith" link) so reviewers can open evidence directly.
