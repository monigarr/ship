...
| Sunday, Noon | Final Submission | `PRESEARCH.md` | Submit completed pre-search checklist documenting scope, architecture, and deployment reasoning. |
| Sunday, Noon | Final Submission | `FLEETGRAPH.md` | Submit all required sections completed, including Cost Analysis and production cost projections. |
| Sunday, Noon | Final Submission Evidence | Public deployment URL + shared trace URLs | Provide public access to running solution and final observability evidence for grading. |
